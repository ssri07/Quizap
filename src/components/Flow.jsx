  ...
  return (
    <section className="py-20">
      ...
      <div className="flex items-center">
        <a href="#amount">
          <div className="shadow-xl hover:outline bg-[#dde6f8] -skew-x-3 outline-[#4d5b9e] outline-offset-4 outline-1 rounded-lg flex flex-col items-center space-y-5 px-5 py-8">
